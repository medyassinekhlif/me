...
import OgsPaperPage from './OgsPaperPage'
import {
  FaArrowRight,
  FaCodeBranch,
  FaEnvelope,
...
function App() {
  ...
  if (normalizedPath.endsWith('/ogs')) {
    return <OgsPaperPage />
  }
      ...
      <header className="fixed inset-x-0 top-0 z-40 border-b border-white/10 bg-slate-950/80 backdrop-blur-xl">
        <nav className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-3 md:px-8">
          ...
          <div className="hidden items-center gap-6 text-sm text-slate-200 md:flex">
            ...
            <a href={ogsPageUrl} className="transition hover:text-cyan-200">
              OGS Paper
            </a>
          </div>
          <a
        ...
        <article id="github" className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 md:p-8">
          ...
          >
            <div className="grid gap-0 md:grid-cols-[180px_1fr]">
              <div className="flex h-48 px-2 items-center justify-center overflow-hidden bg-white md:h-full">
                <img
                  src={ogsLogoUrl}
              ...
              <div className="p-5 md:p-6">
                ...
                <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
                  ...
                  reproducible symbolic music pipeline built around MIDI, SFZ, sfizz, and a
                  license-conscious deployment model.
                </p>
              </div>
            </div>
          </a>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3 text-sm text-slate-300">
            ...
            <a
              href={ogsPageUrl}
              className="inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-cyan-300/10 px-4 py-1.5 text-cyan-100 transition hover:scale-105"
            >
